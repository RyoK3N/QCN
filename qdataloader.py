...
class QCNDataloader(PoseDataLoader):
    ...
    def __init__(self, train_file, val_file, projection_matrix=None):
        ...
        self.projection_matrix = projection_matrix  # (if needed later)
    ...
    def __getitem__(self, idx):
        ...
        # Note: In our dataset, the translation is in the last row (first three columns)
        ...
        return {
            ...
            'view_rot_quat': view_rot_quat.elements,   # (4,) array [w, x, y, z]
